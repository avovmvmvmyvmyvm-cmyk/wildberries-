...
import type { MeasurementData } from './MeasurementData';
import {
    MeasurementDataFromJSON,
    MeasurementDataFromJSONTyped,
    MeasurementDataToJSON,
    MeasurementDataToJSONTyped,
...
export function MeasurementFromJSONTyped(json: any, ignoreDiscriminator: boolean): Measurement {
    ...
    return {
        ...
        'data': MeasurementDataFromJSON(json['data']),
    };
}
...
export function MeasurementToJSONTyped(value?: Measurement | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'data': MeasurementDataToJSON(value['data']),
    };
}
