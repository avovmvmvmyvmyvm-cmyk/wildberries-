...
import type { PenaltyData } from './PenaltyData';
import {
    PenaltyDataFromJSON,
    PenaltyDataFromJSONTyped,
    PenaltyDataToJSON,
    PenaltyDataToJSONTyped,
} from './PenaltyData';
...
/**
 * Check if a given object implements the Penalty interface.
 */
export function instanceOfPenalty(value: object): value is Penalty {
...
export function PenaltyFromJSONTyped(json: any, ignoreDiscriminator: boolean): Penalty {
    ...
    return {
        ...
        'data': PenaltyDataFromJSON(json['data']),
    };
}

export function PenaltyToJSON(json: any): Penalty {
    return PenaltyToJSONTyped(json, false);
}

export function PenaltyToJSONTyped(value?: Penalty | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': PenaltyDataToJSON(value['data']),
    };
}
