 ...
 * 
 * @export
 * @interface ApiV1SupplierIncomesGet401Response
 */
export interface ApiV1SupplierIncomesGet401Response {
    /**
     * Заголовок ошибки
     * @type {string}
     * @memberof ApiV1SupplierIncomesGet401Response
     */
    title?: string;
    /**
     * Детали ошибки
...
/**
 * Check if a given object implements the ApiV1SupplierIncomesGet401Response interface.
 */
export function instanceOfApiV1SupplierIncomesGet401Response(value: object): value is ApiV1SupplierIncomesGet401Response {
    return true;
}

export function ApiV1SupplierIncomesGet401ResponseFromJSON(json: any): ApiV1SupplierIncomesGet401Response {
    return ApiV1SupplierIncomesGet401ResponseFromJSONTyped(json, false);
}

export function ApiV1SupplierIncomesGet401ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApiV1SupplierIncomesGet401Response {
    if (json == null) {
        return json;
    }
    return {
...
export function ApiV1SupplierIncomesGet401ResponseToJSON(json: any): ApiV1SupplierIncomesGet401Response {
    return ApiV1SupplierIncomesGet401ResponseToJSONTyped(json, false);
}

export function ApiV1SupplierIncomesGet401ResponseToJSONTyped(value?: ApiV1SupplierIncomesGet401Response | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
