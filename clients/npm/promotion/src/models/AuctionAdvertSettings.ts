...
export interface AuctionAdvertSettings {
     ...
     * 
     * @type {string}
     * @memberof AuctionAdvertSettings
     */
    paymentType: AuctionAdvertSettingsPaymentTypeEnum;
    /**
     * Имя кампании
     * @type {string}
     * @memberof AuctionAdvertSettings
 ...
 * @export
 */
export const AuctionAdvertSettingsPaymentTypeEnum = {
    Cpm: 'cpm',
    Cpc: 'cpc'
} as const;
export type AuctionAdvertSettingsPaymentTypeEnum = typeof AuctionAdvertSettingsPaymentTypeEnum[keyof typeof AuctionAdvertSettingsPaymentTypeEnum];


/**
 * Check if a given object implements the AuctionAdvertSettings interface.
 */
export function instanceOfAuctionAdvertSettings(value: object): value is AuctionAdvertSettings {
...
export function AuctionAdvertSettingsFromJSON(json: any): AuctionAdvertSettings {
    return AuctionAdvertSettingsFromJSONTyped(json, false);
}

export function AuctionAdvertSettingsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuctionAdvertSettings {
    if (json == null) {
        return json;
    }
    return {
...
export function AuctionAdvertSettingsToJSON(json: any): AuctionAdvertSettings {
    return AuctionAdvertSettingsToJSONTyped(json, false);
}

export function AuctionAdvertSettingsToJSONTyped(value?: AuctionAdvertSettings | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
