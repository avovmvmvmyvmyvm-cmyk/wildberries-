...
/**
 * Check if a given object implements the AuctionAdvertBids interface.
 */
export function instanceOfAuctionAdvertBids(value: object): value is AuctionAdvertBids {
...
export function AuctionAdvertBidsFromJSON(json: any): AuctionAdvertBids {
    return AuctionAdvertBidsFromJSONTyped(json, false);
}

export function AuctionAdvertBidsFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuctionAdvertBids {
    if (json == null) {
        return json;
    }
    return {
...
export function AuctionAdvertBidsToJSON(json: any): AuctionAdvertBids {
    return AuctionAdvertBidsToJSONTyped(json, false);
}

export function AuctionAdvertBidsToJSONTyped(value?: AuctionAdvertBids | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
