 ...
 * 
 * @export
 * @interface AdvV1SearchSetExcludedPostRequest
 */
export interface AdvV1SearchSetExcludedPostRequest {
    /**
     * Список минус-фраз, до 1000 фраз
     * @type {Array<string>}
     * @memberof AdvV1SearchSetExcludedPostRequest
     */
    excluded?: Array<string>;
}

/**
 * Check if a given object implements the AdvV1SearchSetExcludedPostRequest interface.
 */
export function instanceOfAdvV1SearchSetExcludedPostRequest(value: object): value is AdvV1SearchSetExcludedPostRequest {
    return true;
}

export function AdvV1SearchSetExcludedPostRequestFromJSON(json: any): AdvV1SearchSetExcludedPostRequest {
    return AdvV1SearchSetExcludedPostRequestFromJSONTyped(json, false);
}

export function AdvV1SearchSetExcludedPostRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AdvV1SearchSetExcludedPostRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function AdvV1SearchSetExcludedPostRequestToJSON(json: any): AdvV1SearchSetExcludedPostRequest {
    return AdvV1SearchSetExcludedPostRequestToJSONTyped(json, false);
}

export function AdvV1SearchSetExcludedPostRequestToJSONTyped(value?: AdvV1SearchSetExcludedPostRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
