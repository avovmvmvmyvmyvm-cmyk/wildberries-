 ...
 * 
 * @export
 * @interface AdvV1SearchSetPlusPostRequest
 */
export interface AdvV1SearchSetPlusPostRequest {
    /**
     * Список фиксированных фраз (max. 100)
     * @type {Array<string>}
     * @memberof AdvV1SearchSetPlusPostRequest
     */
    pluse?: Array<string>;
}

/**
 * Check if a given object implements the AdvV1SearchSetPlusPostRequest interface.
 */
export function instanceOfAdvV1SearchSetPlusPostRequest(value: object): value is AdvV1SearchSetPlusPostRequest {
    return true;
}

export function AdvV1SearchSetPlusPostRequestFromJSON(json: any): AdvV1SearchSetPlusPostRequest {
    return AdvV1SearchSetPlusPostRequestFromJSONTyped(json, false);
}

export function AdvV1SearchSetPlusPostRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): AdvV1SearchSetPlusPostRequest {
    if (json == null) {
        return json;
    }
    return {
...
export function AdvV1SearchSetPlusPostRequestToJSON(json: any): AdvV1SearchSetPlusPostRequest {
    return AdvV1SearchSetPlusPostRequestToJSONTyped(json, false);
}

export function AdvV1SearchSetPlusPostRequestToJSONTyped(value?: AdvV1SearchSetPlusPostRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
