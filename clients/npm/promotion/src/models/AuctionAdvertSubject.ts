...
/**
 * Check if a given object implements the AuctionAdvertSubject interface.
 */
export function instanceOfAuctionAdvertSubject(value: object): value is AuctionAdvertSubject {
    if (!('id' in value) || value['id'] === undefined) return false;
    if (!('name' in value) || value['name'] === undefined) return false;
    return true;
}

export function AuctionAdvertSubjectFromJSON(json: any): AuctionAdvertSubject {
    return AuctionAdvertSubjectFromJSONTyped(json, false);
}

export function AuctionAdvertSubjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): AuctionAdvertSubject {
    if (json == null) {
        return json;
    }
    return {
...
export function AuctionAdvertSubjectToJSON(json: any): AuctionAdvertSubject {
    return AuctionAdvertSubjectToJSONTyped(json, false);
}

export function AuctionAdvertSubjectToJSONTyped(value?: AuctionAdvertSubject | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
