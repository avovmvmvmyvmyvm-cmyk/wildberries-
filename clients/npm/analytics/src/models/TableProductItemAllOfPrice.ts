 ...
 * Цена
 * @export
 * @interface TableProductItemAllOfPrice
 */
export interface TableProductItemAllOfPrice {
    /**
     * Минимальная цена продавца со скидкой продавца (без учёта скидки WB Клуба)
     * @type {number}
     * @memberof TableProductItemAllOfPrice
     */
    minPrice: number;
    /**
...
/**
 * Check if a given object implements the TableProductItemAllOfPrice interface.
 */
export function instanceOfTableProductItemAllOfPrice(value: object): value is TableProductItemAllOfPrice {
    if (!('minPrice' in value) || value['minPrice'] === undefined) return false;
    if (!('maxPrice' in value) || value['maxPrice'] === undefined) return false;
    return true;
}

export function TableProductItemAllOfPriceFromJSON(json: any): TableProductItemAllOfPrice {
    return TableProductItemAllOfPriceFromJSONTyped(json, false);
}

export function TableProductItemAllOfPriceFromJSONTyped(json: any, ignoreDiscriminator: boolean): TableProductItemAllOfPrice {
    if (json == null) {
        return json;
    }
    return {
...
export function TableProductItemAllOfPriceToJSON(json: any): TableProductItemAllOfPrice {
    return TableProductItemAllOfPriceToJSONTyped(json, false);
}

export function TableProductItemAllOfPriceToJSONTyped(value?: TableProductItemAllOfPrice | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
