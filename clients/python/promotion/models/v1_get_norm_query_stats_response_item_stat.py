...
class V1GetNormQueryStatsResponseItemStat(BaseModel):
    ...
    ctr: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="CTR (click-through rate) — отношение числа кликов к количеству показов в процентах")
