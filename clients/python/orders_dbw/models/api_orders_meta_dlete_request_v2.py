...
class ApiOrdersMetaDleteRequestV2(BaseModel):
    ...
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="Название метаданных для удаления. Передаётся только одно значение", json_schema_extra={"examples": ["sgtin"]})
