...
// checks if the AdvV0AuctionBidsPatch200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdvV0AuctionBidsPatch200Response{}
...
type _AdvV0AuctionBidsPatch200Response AdvV0AuctionBidsPatch200Response

// NewAdvV0AuctionBidsPatch200Response instantiates a new AdvV0AuctionBidsPatch200Response object
...
func NewAdvV0AuctionBidsPatch200Response(bids []AdvV0AuctionBidsPatch200ResponseBidsInner) *AdvV0AuctionBidsPatch200Response {
	this := AdvV0AuctionBidsPatch200Response{}
	this.Bids = bids
	return &this
}

// NewAdvV0AuctionBidsPatch200ResponseWithDefaults instantiates a new AdvV0AuctionBidsPatch200Response object
...
func (o *AdvV0AuctionBidsPatch200Response) GetBids() []AdvV0AuctionBidsPatch200ResponseBidsInner {
	if o == nil {
		var ret []AdvV0AuctionBidsPatch200ResponseBidsInner
		return ret
	}
...
func (o *AdvV0AuctionBidsPatch200Response) GetBidsOk() ([]AdvV0AuctionBidsPatch200ResponseBidsInner, bool) {
	if o == nil {
		return nil, false
	}
	return o.Bids, true
...
func (o *AdvV0AuctionBidsPatch200Response) SetBids(v []AdvV0AuctionBidsPatch200ResponseBidsInner) {
	o.Bids = v
}
...
func (o *AdvV0AuctionBidsPatch200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varAdvV0AuctionBidsPatch200Response := _AdvV0AuctionBidsPatch200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAdvV0AuctionBidsPatch200Response)

	if err != nil {
		return err
	}

	*o = AdvV0AuctionBidsPatch200Response(varAdvV0AuctionBidsPatch200Response)

	return err
}

type NullableAdvV0AuctionBidsPatch200Response struct {
	value *AdvV0AuctionBidsPatch200Response
	isSet bool
}

func (v NullableAdvV0AuctionBidsPatch200Response) Get() *AdvV0AuctionBidsPatch200Response {
	return v.value
}

func (v *NullableAdvV0AuctionBidsPatch200Response) Set(val *AdvV0AuctionBidsPatch200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAdvV0AuctionBidsPatch200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAdvV0AuctionBidsPatch200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdvV0AuctionBidsPatch200Response(val *AdvV0AuctionBidsPatch200Response) *NullableAdvV0AuctionBidsPatch200Response {
	return &NullableAdvV0AuctionBidsPatch200Response{value: val, isSet: true}
}

func (v NullableAdvV0AuctionBidsPatch200Response) MarshalJSON() ([]byte, error) {
