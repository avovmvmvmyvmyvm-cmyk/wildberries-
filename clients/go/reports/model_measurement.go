...
func NewMeasurement(data MeasurementData) *Measurement {
	this := Measurement{}
	this.Data = data
	return &this
}
...
func (o *Measurement) GetData() MeasurementData {
	if o == nil {
...
func (o *Measurement) GetDataOk() (*MeasurementData, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Data, true
...
func (o *Measurement) SetData(v MeasurementData) {
	o.Data = v
}
