...
type ApiApiV1AnalyticsCharacteristicsChangeGetRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
	dateFrom *string
	dateTo *string
...
// Начало отчётного периода, &#x60;ГГГГ-ММ-ДД&#x60;
func (r ApiApiV1AnalyticsCharacteristicsChangeGetRequest) DateFrom(dateFrom string) ApiApiV1AnalyticsCharacteristicsChangeGetRequest {
	r.dateFrom = &dateFrom
	return r
}

// Конец отчётного периода, &#x60;ГГГГ-ММ-ДД&#x60;
func (r ApiApiV1AnalyticsCharacteristicsChangeGetRequest) DateTo(dateTo string) ApiApiV1AnalyticsCharacteristicsChangeGetRequest {
	r.dateTo = &dateTo
	return r
}

func (r ApiApiV1AnalyticsCharacteristicsChangeGetRequest) Execute() (*ApiV1AnalyticsCharacteristicsChangeGet200Response, *http.Response, error) {
	return r.ApiService.ApiV1AnalyticsCharacteristicsChangeGetExecute(r)
}

/*
ApiV1AnalyticsCharacteristicsChangeGet Смена характеристик

Метод будет отключён 20 января. Используйте [актуальный метод](/openapi/reports#tag/Otchyoty-ob-uderzhaniyah/operation/getDeductions)
...
| 1 минута | 1 запрос | 1 минута | 10 запросов |
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiApiV1AnalyticsCharacteristicsChangeGetRequest

Deprecated
*/
func (a *DefaultApiService) ApiV1AnalyticsCharacteristicsChangeGet(ctx context.Context) ApiApiV1AnalyticsCharacteristicsChangeGetRequest {
	return ApiApiV1AnalyticsCharacteristicsChangeGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Deprecated
func (a *DefaultApiService) ApiV1AnalyticsCharacteristicsChangeGetExecute(r ApiApiV1AnalyticsCharacteristicsChangeGetRequest) (*ApiV1AnalyticsCharacteristicsChangeGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ApiV1AnalyticsCharacteristicsChangeGet200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.ApiV1AnalyticsCharacteristicsChangeGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/analytics/characteristics-change"
...
type ApiApiV1AnalyticsIncorrectAttachmentsGetRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
	dateFrom *string
	dateTo *string
...
// Начало отчётного периода, &#x60;ГГГГ-ММ-ДД&#x60; 
func (r ApiApiV1AnalyticsIncorrectAttachmentsGetRequest) DateFrom(dateFrom string) ApiApiV1AnalyticsIncorrectAttachmentsGetRequest {
	r.dateFrom = &dateFrom
	return r
}

// Конец отчётного периода, &#x60;ГГГГ-ММ-ДД&#x60; 
func (r ApiApiV1AnalyticsIncorrectAttachmentsGetRequest) DateTo(dateTo string) ApiApiV1AnalyticsIncorrectAttachmentsGetRequest {
	r.dateTo = &dateTo
	return r
}

func (r ApiApiV1AnalyticsIncorrectAttachmentsGetRequest) Execute() (*ApiV1AnalyticsIncorrectAttachmentsGet200Response, *http.Response, error) {
	return r.ApiService.ApiV1AnalyticsIncorrectAttachmentsGetExecute(r)
}

/*
ApiV1AnalyticsIncorrectAttachmentsGet Подмена товара
...
| 1 минута | 1 запрос | 1 минута | 10 запросов |
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiApiV1AnalyticsIncorrectAttachmentsGetRequest

Deprecated
*/
func (a *DefaultApiService) ApiV1AnalyticsIncorrectAttachmentsGet(ctx context.Context) ApiApiV1AnalyticsIncorrectAttachmentsGetRequest {
	return ApiApiV1AnalyticsIncorrectAttachmentsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Deprecated
func (a *DefaultApiService) ApiV1AnalyticsIncorrectAttachmentsGetExecute(r ApiApiV1AnalyticsIncorrectAttachmentsGetRequest) (*ApiV1AnalyticsIncorrectAttachmentsGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ApiV1AnalyticsIncorrectAttachmentsGet200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.ApiV1AnalyticsIncorrectAttachmentsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/analytics/incorrect-attachments"
...
Метод возвращает информацию обо всех заказах.<br>Данные обновляются раз в 30 минут.<br><br>
...
Метод возвращает количество остатков товаров на складах WB.<br>Данные обновляются раз в 30 минут.
<br><br>
