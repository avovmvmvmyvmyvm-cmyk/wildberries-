...
pub struct GetDeductions200Response {
    #[serde(rename = "data")]
    pub data: Box<models::GetDeductions200ResponseData>,
}

impl GetDeductions200Response {
    pub fn new(data: models::GetDeductions200ResponseData) -> GetDeductions200Response {
