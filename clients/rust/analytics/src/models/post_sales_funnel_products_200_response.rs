...
pub struct PostSalesFunnelProducts200Response {
    #[serde(rename = "data")]
    pub data: Box<models::PostSalesFunnelProducts200ResponseData>,
}

impl PostSalesFunnelProducts200Response {
    pub fn new(data: models::PostSalesFunnelProducts200ResponseData) -> PostSalesFunnelProducts200Response {
