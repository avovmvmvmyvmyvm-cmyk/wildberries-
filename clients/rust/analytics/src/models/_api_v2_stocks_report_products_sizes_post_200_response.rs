...
pub struct ApiV2StocksReportProductsSizesPost200Response {
    #[serde(rename = "data")]
    pub data: Box<models::TableSizeResponse>,
}

impl ApiV2StocksReportProductsSizesPost200Response {
    pub fn new(data: models::TableSizeResponse) -> ApiV2StocksReportProductsSizesPost200Response {
