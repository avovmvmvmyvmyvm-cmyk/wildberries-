...
pub struct ProductsResponseProductsInner {
    #[serde(rename = "product")]
    pub product: Box<models::ProductsResponseProductsInnerProduct>,
    #[serde(rename = "statistic")]
    pub statistic: Box<models::ProductsResponseProductsInnerStatistic>,
}

impl ProductsResponseProductsInner {
    pub fn new(product: models::ProductsResponseProductsInnerProduct, statistic: models::ProductsResponseProductsInnerStatistic) -> ProductsResponseProductsInner {
