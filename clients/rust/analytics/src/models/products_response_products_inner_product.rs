...
pub struct ProductsResponseProductsInnerProduct {
    /// Артикул WB
    #[serde(rename = "nmId")]
    pub nm_id: i64,
    ...
    #[serde(rename = "stocks")]
    pub stocks: Box<models::ProductStocks>,
}

impl ProductsResponseProductsInnerProduct {
    pub fn new(nm_id: i64, title: String, vendor_code: String, brand_name: String, subject_id: i32, subject_name: String, tags: Vec<models::Tag>, product_rating: f64, feedback_rating: f64, stocks: models::ProductStocks) -> ProductsResponseProductsInnerProduct {
