...
pub struct SearchReportProductReqParams {
...
impl SearchReportProductReqParams {
    /// Параметры отчёта
    pub fn new(current_period: models::Period, position_cluster: models::PositionCluster, order_by: models::OrderBy) -> SearchReportProductReqParams {
