...
pub struct ApiV2NmReportDownloadsGet400Response {
    /// Заголовок ошибки
    #[serde(rename = "title")]
    pub title: String,
    /// Детали ошибки
...
impl ApiV2NmReportDownloadsGet400Response {
    pub fn new(title: String, detail: String, request_id: String, origin: String) -> ApiV2NmReportDownloadsGet400Response {
