...
pub struct SalesFunnelProductReq {
    ...
    #[serde(rename = "params")]
    pub params: Box<models::SalesFunnelProductReqParams>,
}

impl SalesFunnelProductReq {
    pub fn new(id: uuid::Uuid, report_type: String, params: models::SalesFunnelProductReqParams) -> SalesFunnelProductReq {
