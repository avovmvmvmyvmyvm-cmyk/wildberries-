...
pub struct SearchReportProductReq {
    ...
    #[serde(rename = "params")]
    pub params: Box<models::SearchReportProductReqParams>,
}

impl SearchReportProductReq {
    pub fn new(id: uuid::Uuid, report_type: String, params: models::SearchReportProductReqParams) -> SearchReportProductReq {
