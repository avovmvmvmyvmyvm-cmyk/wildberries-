...
pub struct ProductsResponseProductsInnerStatistic {
...
impl ProductsResponseProductsInnerStatistic {
    pub fn new(selected: models::StatisticsSelected) -> ProductsResponseProductsInnerStatistic {
