...
pub struct ApiV2SearchReportTableDetailsPost200Response {
    #[serde(rename = "data")]
    pub data: Box<models::TableDetailsResponse>,
}

impl ApiV2SearchReportTableDetailsPost200Response {
    pub fn new(data: models::TableDetailsResponse) -> ApiV2SearchReportTableDetailsPost200Response {
