...
pub struct TableItemBaseCommonFeedbackRating {
    /// Текущий рейтинг
...
impl TableItemBaseCommonFeedbackRating {
    /// Рейтинг товара по отзывам
    pub fn new(current: f64, percentile: Option<f64>) -> TableItemBaseCommonFeedbackRating {
