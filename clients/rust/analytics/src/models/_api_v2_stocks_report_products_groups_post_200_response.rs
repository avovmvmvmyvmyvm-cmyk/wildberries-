...
pub struct ApiV2StocksReportProductsGroupsPost200Response {
    #[serde(rename = "data")]
    pub data: Box<models::TableGroupResponseSt>,
}

impl ApiV2StocksReportProductsGroupsPost200Response {
    pub fn new(data: models::TableGroupResponseSt) -> ApiV2StocksReportProductsGroupsPost200Response {
