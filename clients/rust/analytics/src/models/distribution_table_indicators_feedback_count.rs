...
pub struct DistributionTableIndicatorsFeedbackCount {
...
impl DistributionTableIndicatorsFeedbackCount {
    /// Все отзывы за период
    pub fn new(current: i32) -> DistributionTableIndicatorsFeedbackCount {
