...
pub struct ApiV2SearchReportTableGroupsPost200Response {
    #[serde(rename = "data")]
    pub data: Box<models::TableGroupResponse>,
}

impl ApiV2SearchReportTableGroupsPost200Response {
    pub fn new(data: models::TableGroupResponse) -> ApiV2SearchReportTableGroupsPost200Response {
