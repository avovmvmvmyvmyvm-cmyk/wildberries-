...
pub struct ApiV2StocksReportOfficesPost200Response {
    #[serde(rename = "data")]
    pub data: Box<models::TableShippingOfficeResponse>,
}

impl ApiV2StocksReportOfficesPost200Response {
    pub fn new(data: models::TableShippingOfficeResponse) -> ApiV2StocksReportOfficesPost200Response {
