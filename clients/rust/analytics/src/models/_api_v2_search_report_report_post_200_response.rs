...
pub struct ApiV2SearchReportReportPost200Response {
    #[serde(rename = "data")]
    pub data: Box<models::MainResponse>,
}

impl ApiV2SearchReportReportPost200Response {
    pub fn new(data: models::MainResponse) -> ApiV2SearchReportReportPost200Response {
