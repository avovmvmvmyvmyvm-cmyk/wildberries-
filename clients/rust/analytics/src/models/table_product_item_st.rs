...
pub struct TableProductItemSt {
    ...
    pub metrics: Box<models::TableProductItemStMetrics>,
}

impl TableProductItemSt {
    /// Данные по товару
    pub fn new(nm_id: i64, is_deleted: bool, subject_name: String, name: String, vendor_code: String, brand_name: String, main_photo: String, has_sizes: bool, metrics: models::TableProductItemStMetrics) -> TableProductItemSt {
        TableProductItemSt {
            nm_id,
            is_deleted,
            subject_name,
