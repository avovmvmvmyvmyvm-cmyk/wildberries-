...
pub struct ApiCommunicationsV2NewsGet200Response {
    /// Новости
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::ApiCommunicationsV2NewsGet200ResponseDataInner>>,
}

impl ApiCommunicationsV2NewsGet200Response {
    pub fn new() -> ApiCommunicationsV2NewsGet200Response {
