...
pub struct ApiCommunicationsV2NewsGet200ResponseDataInnerTypesInner {
    /// ID тега
...
impl ApiCommunicationsV2NewsGet200ResponseDataInnerTypesInner {
    pub fn new() -> ApiCommunicationsV2NewsGet200ResponseDataInnerTypesInner {
