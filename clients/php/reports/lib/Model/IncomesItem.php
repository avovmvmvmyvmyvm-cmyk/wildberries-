...
class IncomesItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets date
     *
     * @param string|null $date Дата поступления. Если часовой пояс не указан, то берётся Московское время UTC+3.
     *
     * @return self
     */
     ...
     * Sets date_close
     *
     * @param string|null $date_close Дата принятия (закрытия) в WB. Если часовой пояс не указан, то берётся Московское время UTC+3
     *
     * @return self
     */
